...
OWNER_ID = int(getenv("OWNER_ID", 5847566596))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://t.me/SoURce_EIBoSs",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")

GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/mhdippo")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AGYIGY")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/355c8640be8e83990a26d.jpg"
)
PING_IMG_URL = getenv(
